    ...
    <div className="h-screen max-h-200  flex flex-col  items-center text-white">
      ...
      <div className=" h-[40%] flex flex-col items-center justify-center gap-3">
        <div className="flex items-center justify-center gap-1">
          ...
          <p className=" text- text-sm  md:text-md lg:text-lg">available for work</p>
        </div>
        <div className="flex flex-col items-center justify-center gap-7">
          <p className="font-['Anton'] text-3xl md:text-5xl lg:text-7xl w-full md:w-160  text-center">
