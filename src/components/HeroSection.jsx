  ...
  return (
    <>
      <div className="h-screen  flex flex-col  items-center text-white">
        <div className="   h-[30%] w-full flex justify-end items-start text-2xl gap-10 mt-[calc(100%-97%)] mr-50">
          <p>home</p>
          <p>About</p> <p>Contact</p>
        </div>
        ...
        <div className="  h-[30%] flex items-end justify-center  text-2xl gap-30 mb-[calc(100%-97%)]">
          <div className="flex items-center justify-center gap-1">
